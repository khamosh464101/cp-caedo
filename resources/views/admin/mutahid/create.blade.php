<x-admin-layout>
    ...
    <div class="w-full h-screen overflow-x-hidden border-t flex flex-col">
        <main class="w-full flex-grow p-6">
            <h1 class="w-full text-3xl text-black pb-6">Add Audit Report</h1>

            <div class="w-full mt-12">
                <p class="text-xl pb-3 flex items-center">
                    <i class="fas fa-list mr-3"></i> Audit Report Details
                </p>
                <form method="POST" action="{{ route('admin.mutahid.store') }}" enctype="multipart/form-data">
                    @csrf
                ...
                <div class="mb-1">
                    ...
                    <select required class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" id="selectType" name="is_mutahid_dfi">
                        <option value="1" selected>mutahid DFI</option>
                        <option value="0">Audit Report</option>
                      </select>
                </div>
                <div class="mb-1">
                ...
                {{--  --}}
                <div class="mb-2">
                    <label class="block text-sm text-gray-600" for="message">Image (300X432)</label>
                ...
                <button type="submit" class="px-4 py-1 text-white font-light tracking-wider bg-blue-600 rounded">Add Audit Report</button>
                </form>
            </div>
        </main>
    </div>

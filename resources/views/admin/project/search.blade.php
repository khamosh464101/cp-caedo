<x-admin-layout>
    ...
    <div class="w-full h-screen overflow-x-hidden border-t flex flex-col">
        <main class="w-full flex-grow p-6">
            <h1 class="w-full text-3xl text-black pb-6">Project Update</h1>
            ...
            <div class="w-full mt-12">
                ...
                @if($posts->isNotEmpty())
                <div class="w-full bg-white text-left p-4 mb-2">Found {{ $posts->total() }} Records in Project Updates</div>

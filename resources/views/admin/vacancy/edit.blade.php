        ...
        <main class="w-full flex-grow p-6">
            ...
            <div class="w-full mt-12">
                ...
                <div class="mb-1">
                    ...
                    <input required type="text" min="1900" max="2100" id="vacancyNumber" value="{{ $vacancy->vacancy_number }}" name="vacancy_number" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="CAEDO/HR/187" required>
                </div>
                <div class="mb-1">
                    <label for="title" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Title</label>
                    <input required type="text"  id="title" value="{{ $vacancy->title }}" name="title" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="IT Officer" required>
                </div>
                <div class="mb-1">
                    <label for="post_date" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Post Date</label>
                    <input required type="date"  id="post_date" value="{{ $vacancy->post_date }}" name="post_date" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"  required>
                </div>
                <div class="mb-1">
                    <label for="close_date" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Close Date</label>
                    <input required type="date"  id="close_date" value="{{ $vacancy->close_date }}" name="close_date" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"  required>
                </div>
                <div class="mb-1">
                    ...
                    <select required class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" id="selectType" name="is_vacancy">
                        <option value="1" {{ $vacancy->is_vacancy ? 'selected' : '' }}>Vacancy</option>
                        <option value="0" {{ !$vacancy->is_vacancy ? 'selected' : '' }}>Volunteer Opportunity</option>
                      </select>
                </div>
                <div class="mb-1">
                    ...
                    <select required class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" id="selectType" name="published">
                        <option value="1" {{ $vacancy->published ? 'selected' : '' }}>Yes</option>
                        <option value="0" {{ !$vacancy->published ? 'selected' : '' }}>No</option>
                      </select>
                </div>
